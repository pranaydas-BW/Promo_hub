            ...
            onClick={() => {
              const toExport = (fDateFrom || fDateTo ? filtered : activeRows).flatMap(r => {
                ...
                return ranges.map(dr => ({
                  ...
                  promo_details: r.promo_details || '',
                  assortment_type: r.assortment_type || '',
                  broadway_discount_pct: r.broadway_discount_pct || r.broadway_discount_both || r.broadway_pct_split || '',
                  brand_discount_pct: r.brand_discount_pct || r.brand_discount_both || r.brand_pct_split || '',
                  valid_from: dr.from || '',
                  valid_till: dr.till || '',
                  status: r.status || '',
